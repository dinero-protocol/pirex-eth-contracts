 ...
 */
contract SuperLST is LiquidStakingTokenCompose {
    /**
     * @notice Contract constructor to initialize LiquidStakingTokenCompose with necessary parameters and configurations.
     * @dev    This constructor sets up the LiquidStakingTokenCompose contract, configuring key parameters and initializing state variables.
